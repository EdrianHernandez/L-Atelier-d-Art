...
const App = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col selection:bg-gray-100 selection:text-black">
      {/* Header */}
      <header className="py-12 px-6 md:px-12 flex flex-col md:flex-row items-center justify-between gap-8 sticky top-0 bg-white/95 backdrop-blur-md z-0">
      ...
      <main className="flex-grow pt-12">
        <section className="mb-20 text-center px-6">
          <h2 className="serif text-sm md:text-sm lg:text-sm mb-4 leading-tight">
